...
# Standard Demo
############################
# http://chrisc-test-0001.roachprod.crdb.io:26258/#/overview/list
# roachprod ssh chrisc-test:7
...
#roachprod run $CLUSTER:1 <<EOF
#./cockroach sql --insecure -e "CREATE CHANGEFEED FOR TABLE bank.bank INTO 'experimental-s3://chrisc-test/changefeed/bank.sql?AUTH=implicit' WITH updated, resolved;"
#EOF
#aws s3 ls s3://chrisc-test/changefeed/2020-03-11/ --region=us-east-2
